...
Partner::Partner(string path)
    ...
    // accessory_mode
    SysFSValue<int>* accessory_mode = new SysFSValue<int>(path, "accessory_mode", false);
    ...
    SysFSValue<bool>* supports_usb_power_delivery = new SysFSValue<bool>(path, "supports_usb_power_delivery", false);
    addMap(supports_usb_power_delivery);

    // number_of_alternate_modes
    SysFSValue<int>* number_of_alternate_modes = new SysFSValue<int>(path, "number_of_alternate_modes", false);
    addMap(number_of_alternate_modes);

    // type
    SysFSValue<int>* type = new SysFSValue<int>(path, "type", false);
    type->add("not_ufp\n", TYPE_UFP_NOT_UFP);
    type->add("hub\n", TYPE_HUB);
    type->add("peripheral\n", TYPE_UFP_PERIPHERAL);
