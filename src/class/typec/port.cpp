...
Port::Port(string path)    : SysFS(path) { 
    ...
    // power_role
    SysFSValue<int>* power_role = new SysFSValue<int>(path, "power_role", true);
    power_role->add("[sink]\n", POWER_ROLE_SINK);
    ...
    // port_type
    SysFSValue<int>* port_type = new SysFSValue<int>(path, "port_type", true);
    port_type->add("[sink]\n", PORT_TYPE_SINK);
    ...
    // vconn_source
    SysFSValue<bool>* vconn_source = new SysFSValue<bool>(path, "vconn_source", true);
    addMap(vconn_source);

    // power_operation_mode
    SysFSValue<int>* power_operation_mode = new SysFSValue<int>(path, "power_operation_mode", false);
    ...
    // preferred_role
    SysFSValue<int>* preferred_role = new SysFSValue<int>(path, "preferred_role", true);
    ...
    SysFSValue<int>* usb_power_delivery_revision = new SysFSValue<int>(path, "usb_power_delivery_revision", false);
    ...
    // usb_typec_revision
    SysFSValue<int>* usb_typec_revision = new SysFSValue<int>(path, "usb_typec_revision", false);
    ...
    // orientation
    SysFSValue<int>* orientation = new SysFSValue<int>(path, "orientation", false);
